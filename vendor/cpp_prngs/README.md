# cpp_prngs vendored subset

This directory contains the subset of [`ulfben/cpp_prngs`](https://github.com/ulfben/cpp_prngs) required to use `rnd::Random<RomuDuoJr>` in Kotte.
